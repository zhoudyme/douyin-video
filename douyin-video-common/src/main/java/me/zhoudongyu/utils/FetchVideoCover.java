...
public class FetchVideoCover {
    ...
    public static void main(String[] args) {
        // 获取视频信息。
        FetchVideoCover videoInfo = new FetchVideoCover("D:\\Program Files (x86)\\ffmpeg\\bin\\ffmpeg.exe");
        try {
            videoInfo.getCover("D:\\Program Files (x86)\\ffmpeg\\video\\1.mp4", "D:\\Program Files (x86)\\ffmpeg\\video\\1.jpg");
